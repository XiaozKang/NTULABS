...
HD_PWD='C:/Users/TO0009NG/SC3050/SC3050_lab3_5_stage_pipeline/SC3050_lab3_5_stage_pipeline.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pipelined_regfile_5stage.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pipelined_regfile_5stage.tcl
